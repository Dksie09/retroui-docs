...
function Page() {
  ...
  return (
    <>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 mt-20 md:px-8 lg:px-10 xl:px-16 py-8">
          {/* <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
            ...
            >
              ...
              <h1 className="font-minecraft-bold text-lg sm:text-xl">
                RetroUI
              </h1>
            </button>
            <button
          ...
          <div className="mb-8">
            ...
            <p className="text-sm sm:text-base">
              Each component is built to bring nostalgic charm to your modern
              web applications.
            </p>
          </div>
